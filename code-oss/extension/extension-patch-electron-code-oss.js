const vscode = await import("npm:vscode");
...
function activate(context) {
	...
	async function getIndicatorJs() {
		//let indicatorJsPath;
		//let ext = vscode.extensions.getExtension("extension-name-contrib blla");
		//if (ext && ext.extensionPath) {
			//indicatorJsPath = path.resolve(ext.extensionPath, "src/statusbar.js");
		//} else {
			///indicatorJsPath = path.resolve(__dirname, ".js");
		//}
		const indicatorJsContent = `/* eslint-env browser */
(function () {
	function patch() {
