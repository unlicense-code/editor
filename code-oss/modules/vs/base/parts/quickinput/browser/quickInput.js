...
import { ItemActivation, NO_KEY_MODS, QuickInputHideReason } from 'vs/base/parts/quickinput/common/quickInput';
...
class QuickPick extends QuickInput {
    ...
    set toggles(toggles) {
        ...
        const concreteToggles = toggles?.filter(opts => opts instanceof Toggle);
