...
export class QuickInputList {
    ...
    inputElements = [];
    elements = [];
    elementsToIndexes = new Map();
    matchOnDescription = false;
    matchOnDetail = false;
    matchOnLabel = true;
    matchOnLabelMode = 'fuzzy';
    matchOnMeta = true;
    sortByLabel = true;
    _onChangedAllVisibleChecked = new Emitter();
    onChangedAllVisibleChecked = this._onChangedAllVisibleChecked.event;
    _onChangedCheckedCount = new Emitter();
    onChangedCheckedCount = this._onChangedCheckedCount.event;
    _onChangedVisibleCount = new Emitter();
    onChangedVisibleCount = this._onChangedVisibleCount.event;
    _onChangedCheckedElements = new Emitter();
    onChangedCheckedElements = this._onChangedCheckedElements.event;
