...
suite('MarkdownRenderer', () => {
    suite('Sanitization', () => {
        test('Should not render images with unknown schemes', () => {
            ...
            const result = renderMarkdown(markdown).element;
    ...
    suite('Images', () => {
        ...
        test('image width from title params', () => {
            const result = renderMarkdown({ value: `![image](http://example.com/cat.gif|width=100px 'caption')` }).element;
            assertNodeEquals(result, `<div><p><img width="100" title="caption" alt="image" src="http://example.com/cat.gif"></p></div>`);
        });
        test('image height from title params', () => {
            const result = renderMarkdown({ value: `![image](http://example.com/cat.gif|height=100 'caption')` }).element;
            assertNodeEquals(result, `<div><p><img height="100" title="caption" alt="image" src="http://example.com/cat.gif"></p></div>`);
        });
        test('image width and height from title params', () => {
            const result = renderMarkdown({ value: `![image](http://example.com/cat.gif|height=200,width=100 'caption')` }).element;
        ...
        test('image with file uri should render as same origin uri', () => {
            ...
            const result = renderMarkdown({ value: `![image](file:///images/cat.gif)` }).element;
...
`);
    ...
    test('Should not render command links by default', () => {
        ...
        const result = renderMarkdown(md).element;
