...
import { compress, CompressedObjectTreeModel, decompress } from 'vs/base/browser/ui/tree/compressedObjectTreeModel';
...
suite('CompressedObjectTree', function () {
    ...
    suite('CompressedObjectTreeModel', function () {
        ...
        test('ctor', () => {
            const list = [];
            const model = new CompressedObjectTreeModel('test', toList(list));
            assert(model);
