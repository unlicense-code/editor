...
suite('IndexTreeModel', () => {
    test('ctor', () => {
        const list = [];
        const model = new IndexTreeModel('test', toList(list), -1);
        assert(model);
    ...
    test('simple filter', () => {
        ...
        const model = new IndexTreeModel('test', toList(list), -1, { filter });
        model.splice([0], 0, [
            {
                element: 0, children: [
                    { element: 1 },
    ...
    test('recursive filter', () => {
        ...
        const model = new IndexTreeModel('test', toList(list), 'root', { filter });
        model.splice([0], 0, [
            {
