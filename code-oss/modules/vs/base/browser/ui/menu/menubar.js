...
import { cleanMnemonic, Direction, Menu, MENU_ESCAPED_MNEMONIC_REGEX, MENU_MNEMONIC_REGEX } from 'vs/base/browser/ui/menu/menu';
...
export class MenuBar extends Disposable {
    ...
    numMenusShown = 0;
    menuStyle;
    overflowLayoutScheduled = undefined;
