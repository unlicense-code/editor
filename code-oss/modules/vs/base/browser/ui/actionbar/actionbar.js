...
import { ActionRunner, Separator } from 'vs/base/common/actions';
import { Emitter } from 'vs/base/common/event';
import { Disposable, DisposableMap, DisposableStore, dispose } from 'vs/base/common/lifecycle';
...
export class ActionBar extends Disposable {
    ...
    _onDidCancel = this._register(new Emitter({ onWillAddFirstListener: () => this.cancelHasListener = true }));
