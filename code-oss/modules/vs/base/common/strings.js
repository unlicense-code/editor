...
export class AmbiguousCharacters {
    ...
    static cache = new LRUCachedFunction((locales) => {
    ...
    static _locales = new Lazy(() => Object.keys(AmbiguousCharacters.ambiguousCharacterData.getValue()).filter((k) => !k.startsWith('_')));
    static getLocales() {
