...
import { DefaultQuickAccessFilterValue, Extensions } from 'vs/platform/quickinput/common/quickAccess';
...
let QuickAccessController = class QuickAccessController extends Disposable {
    ...
    mapProviderToDescriptor = new Map();
    lastAcceptedPickerValues = new Map();
    visibleQuickAccess = undefined;
