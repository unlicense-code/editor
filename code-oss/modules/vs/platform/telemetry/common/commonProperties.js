 ...
 *--------------------------------------------------------------------------------------------*/
import { isLinuxSnap, platform, PlatformToString } from 'vs/base/common/platform';
...
export async function resolveCommonProperties(fileService, release, hostname, arch, commit, version, machineId, isInternalTelemetry, installSourcePath, product) {
