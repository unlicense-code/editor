...
import { DebounceEmitter, Emitter } from 'vs/base/common/event';
import { DisposableStore } from 'vs/base/common/lifecycle';
import { isIMenuItem, isISubmenuItem, MenuItemAction, MenuRegistry, SubmenuItemAction } from 'vs/platform/actions/common/actions';
...
let MenuInfo = class MenuInfo {
    ...
    _contextKeyService;
    _menuGroups = [];
    _structureContextKeys = new Set();
    _preconditionContextKeys = new Set();
    _toggledContextKeys = new Set();
