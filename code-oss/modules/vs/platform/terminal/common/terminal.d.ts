...
export declare type TerminalShellType = PosixShellType | WindowsShellType | undefined;
export interface IRawTerminalInstanceLayoutInfo<T> {
    relativeSize: number;
    terminal: T;
}
export declare type ITerminalInstanceLayoutInfoById = IRawTerminalInstanceLayoutInfo<number>;
export declare type ITerminalInstanceLayoutInfo = IRawTerminalInstanceLayoutInfo<IPtyHostAttachTarget>;
...
export declare type ITerminalTabLayoutInfoById = IRawTerminalTabLayoutInfo<number>;
...
export declare type TerminalType = 'Task' | 'Local' | undefined;
...
export declare type ITerminalsLayoutInfo = IRawTerminalsLayoutInfo<IPtyHostAttachTarget | null>;
export declare type ITerminalsLayoutInfoById = IRawTerminalsLayoutInfo<number>;
...
export declare const IPtyService: import("vs/platform/instantiation/common/instantiation").ServiceIdentifier<IPtyService>;
...
export declare type WaitOnExitValue = boolean | string | ((exitCode: number) => string);
...
export declare type TerminalIcon = ThemeIcon | URI | {
    light: URI;
    dark: URI;
};
...
export declare type ITerminalProfileObject = ITerminalExecutable | ITerminalProfileSource | IExtensionTerminalProfile | null;
