...
export class NodeJSFileWatcherLibrary extends Disposable {
    ...
    static FILE_CHANGES_HANDLER_DELAY = 50;
    ...
    fileChangesDelayer = this._register(new ThrottledDelayer(NodeJSFileWatcherLibrary.FILE_CHANGES_HANDLER_DELAY));
    fileChangesBuffer = [];
    excludes = parseWatcherPatterns(this.request.path, this.request.excludes);
    includes = this.request.includes ? parseWatcherPatterns(this.request.path, this.request.includes) : undefined;
