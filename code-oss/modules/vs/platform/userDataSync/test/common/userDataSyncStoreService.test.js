...
import { IUserDataSyncStoreService, UserDataSyncStoreError } from 'vs/platform/userDataSync/common/userDataSync';
...
suite('UserDataSyncStoreManagementService', () => {
    ...
    test('test sync store is read from settings', async () => {
        ...
        const testObject = disposableStore.add(client.instantiationService.createInstance(UserDataSyncStoreManagementService));
