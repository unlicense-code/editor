...
export declare const IWorkspaceContextService: import("vs/platform/instantiation/common/instantiation").ServiceIdentifier<IWorkspaceContextService>;
...
export declare const WORKSPACE_SUFFIX: string;
