...
suite('ContextKeyService', () => {
    ...
    test('issue #147732: URIs as context values', () => {
        ...
        const instantiationService = new TestInstantiationService(new ServiceCollection([IConfigurationService, configurationService], [IContextKeyService, contextKeyService], [ITelemetryService, new class extends mock() {
                async publicLog2() {
                    //
                }
            }]));
