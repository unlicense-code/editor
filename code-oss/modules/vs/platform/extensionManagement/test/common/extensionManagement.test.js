...
suite('Extension Identifier Pattern', () => {
    ...
    test('extension key', () => {
        ...
        assert.strictEqual(new ExtensionKey({ id: 'pub.extension-name' }, '1.0.1', "win32-ia32" /* TargetPlatform.WIN32_IA32 */).toString(), `pub.extension-name-1.0.1-${"win32-ia32" /* TargetPlatform.WIN32_IA32 */}`);
    });
