...
import { ExtensionManagementError, ExtensionManagementErrorCode, getTargetPlatform, IExtensionGalleryService } from 'vs/platform/extensionManagement/common/extensionManagement';
import { getGalleryExtensionId } from 'vs/platform/extensionManagement/common/extensionManagementUtil';
import { ExtensionsDownloader } from 'vs/platform/extensionManagement/node/extensionDownloader';
import { InstallGalleryExtensionTask } from 'vs/platform/extensionManagement/node/extensionManagementService';
...
class TestExtensionsScanner extends mock() {
...
class TestInstallGalleryExtensionTask extends InstallGalleryExtensionTask {
    installed = false;
    constructor(extension, extensionDownloader) {
        super({
            name: extension.name,
            publisher: extension.publisher,
            version: extension.version,
            engines: { vscode: '*' },
        }, extension, {}, extensionDownloader, new TestExtensionsScanner(), new NullLogService());
    }
...
suite('InstallGalleryExtensionTask Tests', () => {
    ...
    function anExtensionsDownloader(verificationResult, isSignatureVerificationEnabled) {
