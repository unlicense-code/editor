...
import { Barrier, createCancelablePromise } from 'vs/base/common/async';
...
import { ExtensionManagementError, IExtensionGalleryService, isTargetPlatformCompatible, TargetPlatformToString, ExtensionManagementErrorCode } from 'vs/platform/extensionManagement/common/extensionManagement';
...
export function reportTelemetry(telemetryService, eventName, { extensionData, wasVerified, duration, error, durationSinceUpdate }) {
    let errorcode;
    let errorcodeDetail;
    if (error) {
        if (error instanceof ExtensionManagementError) {
