...
export declare const IDialogService: import("vs/platform/instantiation/common/instantiation").ServiceIdentifier<IDialogService>;
...
export declare const IFileDialogService: import("vs/platform/instantiation/common/instantiation").ServiceIdentifier<IFileDialogService>;
/**
