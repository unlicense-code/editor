...
import { supportsTelemetry, NullAppender, NullTelemetryService, getPiiPathsFromEnvironment, isInternalTelemetry } from 'vs/platform/telemetry/common/telemetryUtils';
...
class SharedProcessMain extends Disposable {
    configuration;
    server = this._register(new MessagePortServer());
    sharedProcessWorkerService = undefined;
    ...
    async initServices() {
        ...
        this._register(new DiskFileSystemProviderClient(mainProcessService.getChannel(LOCAL_FILE_SYSTEM_CHANNEL_NAME), { pathCaseSensitive: isLinux })), Schemas.vscodeUserData, logService));
        ...
        // Native Host
        const nativeHostService = ProxyChannel.toService(mainProcessService.getChannel('nativeHost'), { context: this.configuration.windowId });
