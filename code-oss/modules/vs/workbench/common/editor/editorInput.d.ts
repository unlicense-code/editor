...
import { EditorInputCapabilities, Verbosity, GroupIdentifier, ISaveOptions, IRevertOptions, IMoveResult, IEditorDescriptor, IEditorPane, IUntypedEditorInput, AbstractEditorInput, IEditorIdentifier } from 'vs/workbench/common/editor';
...
export declare abstract class EditorInput extends AbstractEditorInput {
     ...
     */
    readonly onDidChangeLabel: import("vs/base/common/event").Event<void>;
    /**
     * Triggered when this input changes its capabilities.
     */
    readonly onDidChangeCapabilities: import("vs/base/common/event").Event<void>;
    /**
