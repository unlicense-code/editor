...
import { VIEWLET_ID, ISCMService, VIEW_PANE_ID, ISCMViewService, REPOSITORIES_VIEW_PANE_ID } from 'vs/workbench/contrib/scm/common/scm';
...
Registry.as(WorkbenchExtensions.Workbench)
    .registerWorkbenchContribution(DirtyDiffWorkbenchController, 3 /* LifecyclePhase.Restored */);
...
Registry.as(WorkbenchExtensions.Workbench)
    .registerWorkbenchContribution(SCMStatusController, 3 /* LifecyclePhase.Restored */);
