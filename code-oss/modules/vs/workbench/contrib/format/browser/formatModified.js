...
import { formatDocumentRangesWithSelectedProvider } from 'vs/editor/contrib/format/browser/format';
...
registerEditorAction(class FormatModifiedAction extends EditorAction {
    ...
    async run(accessor, editor) {
        ...
        if (isNonEmptyArray(ranges)) {
            return instaService.invokeFunction(formatDocumentRangesWithSelectedProvider, editor, ranges, 1 /* FormattingMode.Explicit */, Progress.None, CancellationToken.None);
        }
    }
});
