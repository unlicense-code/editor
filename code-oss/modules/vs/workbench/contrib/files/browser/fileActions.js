...
import { VIEWLET_ID, VIEW_ID } from 'vs/workbench/contrib/files/common/files';
...
import { NewExplorerItem } from 'vs/workbench/contrib/files/common/explorerModel';
...
export class GlobalCompareResourcesAction extends Action2 {
    ...
    static LABEL = nls.localize('globalCompareFile', "Compare Active File With...");
    constructor() {
        super({
...
export class ToggleAutoSaveAction extends Action2 {
    ...
    static LABEL = nls.localize('toggleAutoSave', "Toggle Auto Save");
    constructor() {
        super({
...
export class FocusFilesExplorer extends Action2 {
    ...
    static LABEL = nls.localize('focusFilesExplorer', "Focus on Files Explorer");
    constructor() {
        super({
...
export class ShowActiveFileInExplorer extends Action2 {
    ...
    static LABEL = nls.localize('showInExplorer', "Reveal Active File in Explorer View");
    constructor() {
        super({
...
export class ShowOpenedFileInNewWindow extends Action2 {
    ...
    static LABEL = nls.localize('openFileInNewWindow', "Open Active File in New Window");
    constructor() {
        super({
            ...
            f1: true,
            category: fileCategory,
            keybinding: { primary: KeyChord(2048 /* KeyMod.CtrlCmd */ | 41 /* KeyCode.KeyK */, 45 /* KeyCode.KeyO */), weight: 200 /* KeybindingWeight.WorkbenchContrib */ },
...
export class CompareWithClipboardAction extends Action2 {
    ...
    static LABEL = nls.localize('compareWithClipboard', "Compare Active File with Clipboard");
...
export const pasteFileHandler = async (accessor) => {
