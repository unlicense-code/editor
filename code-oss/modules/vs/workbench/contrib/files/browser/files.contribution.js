...
import { FILE_EDITOR_INPUT_ID, BINARY_TEXT_FILE_MODE } from 'vs/workbench/contrib/files/common/files';
...
Registry.as(WorkbenchExtensions.Workbench).registerWorkbenchContribution(FileEditorWorkingCopyEditorHandler, 2 /* LifecyclePhase.Ready */);
// Register Explorer views
Registry.as(WorkbenchExtensions.Workbench).registerWorkbenchContribution(ExplorerViewletViewsContribution, 1 /* LifecyclePhase.Starting */);
// Register Text File Editor Tracker
Registry.as(WorkbenchExtensions.Workbench).registerWorkbenchContribution(TextFileEditorTracker, 1 /* LifecyclePhase.Starting */);
// Register Text File Save Error Handler
Registry.as(WorkbenchExtensions.Workbench).registerWorkbenchContribution(TextFileSaveErrorHandler, 1 /* LifecyclePhase.Starting */);
// Register uri display for file uris
Registry.as(WorkbenchExtensions.Workbench).registerWorkbenchContribution(FileUriLabelContribution, 1 /* LifecyclePhase.Starting */);
// Register Workspace Watcher
Registry.as(WorkbenchExtensions.Workbench).registerWorkbenchContribution(WorkspaceWatcher, 3 /* LifecyclePhase.Restored */);
// Register Dirty Files Indicator
Registry.as(WorkbenchExtensions.Workbench).registerWorkbenchContribution(DirtyFilesIndicator, 1 /* LifecyclePhase.Starting */);
// Configuration
