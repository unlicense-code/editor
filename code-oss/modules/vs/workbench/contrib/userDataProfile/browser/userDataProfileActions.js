...
class CreateFromCurrentProfileAction extends Action2 {
    static ID = 'workbench.profiles.actions.createFromCurrentProfile';
    static TITLE = {
...
class CreateEmptyProfileAction extends Action2 {
    static ID = 'workbench.profiles.actions.createEmptyProfile';
    static TITLE = {
...
export class RenameProfileAction extends Action2 {
    static ID = 'workbench.profiles.actions.renameProfile';
    constructor() {
        super({
