...
let WalkthroughsService = class WalkthroughsService extends Disposable {
    ...
    gettingStartedContributions = new Map();
    steps = new Map();
    tasExperimentService;
    sessionInstalledExtensions = new Set();
    categoryVisibilityContextKeys = new Set();
    stepCompletionContextKeyExpressions = new Set();
    stepCompletionContextKeys = new Set();
    triggerInstalledExtensionsRegistered;
