...
suite('Save Participants', function () {
    ...
    test('insert final new line', async function () {
        const model = instantiationService.createInstance(TextFileEditorModel, toResource.call(this, '/path/final_new_line.txt'), 'utf8', undefined);
        await model.resolve();
    ...
    test('trim final new lines', async function () {
        const model = instantiationService.createInstance(TextFileEditorModel, toResource.call(this, '/path/trim_final_new_line.txt'), 'utf8', undefined);
        await model.resolve();
        const configService = new TestConfigurationService();
