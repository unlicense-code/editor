...
export class MergeEditorCopyContentsToJSON extends Action2 {
    constructor() {
        super({
            ...
            title: {
                value: localize('merge.dev.copyState', 'Copy Merge Editor State as JSON'),
...
export class MergeEditorSaveContentsToFolder extends Action2 {
    constructor() {
        super({
            ...
            category: MERGE_EDITOR_CATEGORY,
            title: {
                value: localize('merge.dev.saveContentsToFolder', 'Save Merge Editor State to Folder'),
...
export class MergeEditorLoadContentsFromFolder extends Action2 {
    constructor() {
        super({
            ...
            category: MERGE_EDITOR_CATEGORY,
            title: {
                value: localize('merge.dev.loadContentsFromFolder', 'Load Merge Editor State from Folder'),
