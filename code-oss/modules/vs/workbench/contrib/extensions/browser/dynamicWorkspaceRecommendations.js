...
let DynamicWorkspaceRecommendations = class DynamicWorkspaceRecommendations extends ExtensionRecommendations {
...
DynamicWorkspaceRecommendations = __decorate([
    ...
    __param(1, IWorkspaceTagsService),
    __param(2, IWorkspaceContextService),
    __param(3, IFileService),
    __param(4, ITelemetryService),
    __param(5, IStorageService)
], DynamicWorkspaceRecommendations);
export { DynamicWorkspaceRecommendations };
