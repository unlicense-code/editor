...
import { IExtensionGalleryService, IExtensionManagementService, IExtensionTipsService, getTargetPlatform } from 'vs/platform/extensionManagement/common/extensionManagement';
...
suite('ExtensionRecommendationsService Test', () => {
    ...
    let prompted;
    const promptedEmitter = new Emitter();
