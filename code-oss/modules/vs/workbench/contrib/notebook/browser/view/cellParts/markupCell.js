...
import { CellEditState, CellFocusMode, EXPAND_CELL_INPUT_COMMAND_ID } from 'vs/workbench/contrib/notebook/browser/notebookBrowser';
...
let MarkupCell = class MarkupCell extends Disposable {
    ...
    cellEditorOptions;
    editorOptions;
    constructor(notebookEditor, viewCell, templateData, renderedEditors, accessibilityService, contextKeyService, notebookCellStatusBarService, instantiationService, languageService, configurationService, keybindingService) {
        super();
...
MarkupCell = __decorate([
    ...
    __param(6, INotebookCellStatusBarService),
