...
import { CellEditState, CellFocusMode, expandCellRangesWithHiddenCells } from 'vs/workbench/contrib/notebook/browser/notebookBrowser';
import { cloneNotebookCellTextModel } from 'vs/workbench/contrib/notebook/common/model/notebookCellTextModel';
import { CellKind, SelectionStateType } from 'vs/workbench/contrib/notebook/common/notebookCommon';
import { cellRangeContains, cellRangesToIndexes } from 'vs/workbench/contrib/notebook/common/notebookRange';
...
export function insertCell(languageService, editor, index, type, direction = 'above', initialText = '', ui = false) {
    const viewModel = editor._getViewModel();
