...
export declare const INotebookEditorModelResolverService: import("vs/platform/instantiation/common/instantiation").ServiceIdentifier<INotebookEditorModelResolverService>;
/**
