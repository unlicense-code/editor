...
export declare const INotebookRendererMessagingService: import("vs/platform/instantiation/common/instantiation").ServiceIdentifier<INotebookRendererMessagingService>;
