...
export declare const INotebookService: import("vs/platform/instantiation/common/instantiation").ServiceIdentifier<INotebookService>;
...
export declare class ComplexNotebookProviderInfo {
    readonly viewType: string;
    readonly controller: INotebookContentProvider;
    readonly extensionData: NotebookExtensionDescription;
    constructor(viewType: string, controller: INotebookContentProvider, extensionData: NotebookExtensionDescription);
}
