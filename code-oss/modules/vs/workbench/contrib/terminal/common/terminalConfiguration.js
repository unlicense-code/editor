...
const terminalConfiguration = {
    ...
    properties: {
        ...
        ["terminal.integrated.tabs.separator" /* TerminalSettingId.TerminalTitleSeparator */]: {
            'type': 'string',
            'default': ' - ',
            'markdownDescription': localize("terminal.integrated.tabs.separator", "Separator used by {0} and {0}.", `\`${"terminal.integrated.tabs.title" /* TerminalSettingId.TerminalTitle */}\``, `\`${"terminal.integrated.tabs.description" /* TerminalSettingId.TerminalDescription */}\``)
        },
