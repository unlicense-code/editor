...
export declare const ITerminalService: import("vs/platform/instantiation/common/instantiation").ServiceIdentifier<ITerminalService>;
export declare const ITerminalEditorService: import("vs/platform/instantiation/common/instantiation").ServiceIdentifier<ITerminalEditorService>;
export declare const ITerminalGroupService: import("vs/platform/instantiation/common/instantiation").ServiceIdentifier<ITerminalGroupService>;
export declare const ITerminalInstanceService: import("vs/platform/instantiation/common/instantiation").ServiceIdentifier<ITerminalInstanceService>;
/**
...
export interface ITerminalService extends ITerminalInstanceHost {
    ...
    onDidChangeInstanceIcon: Event<{
        instance: ITerminalInstance;
        userInitiated: boolean;
    }>;
    onDidChangeInstanceColor: Event<{
        instance: ITerminalInstance;
        userInitiated: boolean;
    }>;
...
export declare type ITerminalLocationOptions = TerminalLocation | TerminalEditorLocation | {
...
export declare type TerminalQuickFixMatchResult = {
    commandLineMatch: RegExpMatchArray;
    outputMatch?: RegExpMatchArray | null;
};
export declare type TerminalQuickFixAction = IAction | ITerminalQuickFixCommandAction | ITerminalQuickFixOpenerAction;
export declare type TerminalQuickFixCallback = (matchResult: TerminalQuickFixMatchResult, command: ITerminalCommand) => TerminalQuickFixAction[] | TerminalQuickFixAction | undefined;
