    ...
    constructor(terminalService, notificationService, openerService, externalOpenerService, viewsService, remoteExplorerService, environmentService, contextKeyService, configurationService, debugService, remoteAgentService, tunnelService, hostService, logService) {
        ...
        remoteAgentService.getEnvironment().then(environment => {
            if (environment?.os !== 3 /* OperatingSystem.Linux */) {
                ...
                if (useProc()) {
                    this._register(new ProcAutomaticPortForwarding(configurationService, remoteExplorerService, notificationService, openerService, externalOpenerService, tunnelService, hostService, logService, contextKeyService));
                }
...
class OnAutoForwardedAction extends Disposable {
    ...
    contextKeyService;
    lastNotifyTime;
    static NOTIFY_COOL_DOWN = 5000; // milliseconds
    lastNotification;
    lastShownPort;
    doActionTunnels;
    alreadyOpenedOnce = new Set();
...
class ProcAutomaticPortForwarding extends Disposable {
    ...
    notifiedOnly = new Set();
    notifier;
    initialCandidates = new Set();
    portsFeatures;
    constructor(configurationService, remoteExplorerService, notificationService, openerService, externalOpenerService, tunnelService, hostService, logService, contextKeyService) {
        super();
        this.configurationService = configurationService;
        this.remoteExplorerService = remoteExplorerService;
        this.notificationService = notificationService;
