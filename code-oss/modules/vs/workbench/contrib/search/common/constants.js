...
export const SearchViewVisibleKey = new RawContextKey('searchViewletVisible', true);
export const SearchViewFocusedKey = new RawContextKey('searchViewletFocus', false);
export const InputBoxFocusedKey = new RawContextKey('inputBoxFocus', false);
export const SearchInputBoxFocusedKey = new RawContextKey('searchInputBoxFocus', false);
export const ReplaceInputBoxFocusedKey = new RawContextKey('replaceInputBoxFocus', false);
export const PatternIncludesFocusedKey = new RawContextKey('patternIncludesInputBoxFocus', false);
export const PatternExcludesFocusedKey = new RawContextKey('patternExcludesInputBoxFocus', false);
export const ReplaceActiveKey = new RawContextKey('replaceActive', false);
export const HasSearchResults = new RawContextKey('hasSearchResult', false);
export const FirstMatchFocusKey = new RawContextKey('firstMatchFocus', false);
export const FileMatchOrMatchFocusKey = new RawContextKey('fileMatchOrMatchFocus', false); // This is actually, Match or File or Folder
export const FileMatchOrFolderMatchFocusKey = new RawContextKey('fileMatchOrFolderMatchFocus', false);
export const FileMatchOrFolderMatchWithResourceFocusKey = new RawContextKey('fileMatchOrFolderMatchWithResourceFocus', false); // Excludes "Other files"
export const FileFocusKey = new RawContextKey('fileMatchFocus', false);
export const FolderFocusKey = new RawContextKey('folderMatchFocus', false);
export const ResourceFolderFocusKey = new RawContextKey('folderMatchWithResourceFocus', false);
export const MatchFocusKey = new RawContextKey('matchFocus', false);
export const ViewHasSearchPatternKey = new RawContextKey('viewHasSearchPattern', false);
export const ViewHasReplacePatternKey = new RawContextKey('viewHasReplacePattern', false);
export const ViewHasFilePatternKey = new RawContextKey('viewHasFilePattern', false);
export const ViewHasSomeCollapsibleKey = new RawContextKey('viewHasSomeCollapsibleResult', false);
export const InTreeViewKey = new RawContextKey('inTreeView', false);
