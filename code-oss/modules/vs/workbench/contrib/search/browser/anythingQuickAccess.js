...
import { quickPickItemScorerAccessor, QuickPickItemScorerAccessor, QuickInputHideReason, IQuickInputService } from 'vs/platform/quickinput/common/quickInput';
import { PickerQuickAccessProvider, TriggerAction } from 'vs/platform/quickinput/browser/pickerQuickAccess';
import { prepareQuery, compareItemsByFuzzyScore, scoreItemFuzzy } from 'vs/base/common/fuzzyScorer';
import { QueryBuilder } from 'vs/workbench/services/search/common/queryBuilder';
import { IInstantiationService } from 'vs/platform/instantiation/common/instantiation';
import { getOutOfWorkspaceEditorResources, extractRangeFromFilter } from 'vs/workbench/contrib/search/common/search';
...
import { DisposableStore, toDisposable, MutableDisposable, Disposable } from 'vs/base/common/lifecycle';
...
let AnythingQuickAccessProvider = class AnythingQuickAccessProvider extends PickerQuickAccessProvider {
    ...
    static TYPING_SEARCH_DELAY = 200; // this delay accommodates for the user typing a word and then stops typing to start searching
    pickState = new class {
        provider;
        editorService;
        picker = undefined;
        ...
        fileQueryCache = undefined;
        lastOriginalFilter = undefined;
        lastFilter = undefined;
        lastRange = undefined;
        lastGlobalPicks = undefined;
    ...
    helpQuickAccess = this.instantiationService.createInstance(HelpQuickAccessProvider);
    getHelpPicks(query, token) {
        if (query.normalized) {
