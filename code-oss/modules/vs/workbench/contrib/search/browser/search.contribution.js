...
import { Extensions as ViewExtensions, IViewDescriptorService } from 'vs/workbench/common/views';
...
import { SEARCH_EXCLUDE_CONFIG, VIEWLET_ID, VIEW_ID } from 'vs/workbench/services/search/common/search';
...
registerSingleton(ISearchWorkbenchService, SearchWorkbenchService, 1 /* InstantiationType.Delayed */);
...
Registry.as(WorkbenchExtensions.Workbench).registerWorkbenchContribution(RegisterSearchViewContribution, 1 /* LifecyclePhase.Starting */);
