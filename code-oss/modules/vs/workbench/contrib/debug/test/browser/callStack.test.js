...
import { StackFrame, Thread } from 'vs/workbench/contrib/debug/common/debugModel';
...
export function createTestSession(model, name = 'mockSession', options) {
    ...
    }, undefined, undefined, new TestConfigurationService({ debug: { console: { collapseIdenticalLines: true } } }), undefined, mockWorkspaceContextService, undefined, undefined, undefined, mockUriIdentityService, new TestInstantiationService(), undefined, undefined);
}
