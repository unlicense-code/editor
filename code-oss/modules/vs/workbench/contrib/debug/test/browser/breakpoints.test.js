...
import { Breakpoint } from 'vs/workbench/contrib/debug/common/debugModel';
...
suite('Debug - Breakpoints', () => {
    ...
    test('message and class name', () => {
        ...
        result = getBreakpointMessageAndIcon(2 /* State.Stopped */, true, functionBreakpoint);
        ...
        result = getBreakpointMessageAndIcon(2 /* State.Stopped */, true, breakpoints[0]);
