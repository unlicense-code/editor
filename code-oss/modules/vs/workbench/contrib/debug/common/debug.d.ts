...
export declare type IDebugSessionReplMode = 'separate' | 'mergeWithParent';
 ...
 */
export declare type MemoryRange = IValidMemoryRange | IUnreadableMemoryRange | IErrorMemoryRange;
...
export declare type IAdapterDescriptor = IDebugAdapterExecutable | IDebugAdapterServer | IDebugAdapterNamedPipeServer | IDebugAdapterImpl;
...
export declare const IDebugService: import("vs/platform/instantiation/common/instantiation").ServiceIdentifier<IDebugService>;
