...
import { SIDE_GROUP, ACTIVE_GROUP } from 'vs/workbench/services/editor/common/editorService';
...
export function getUriFromSource(raw, path, sessionId, uriIdentityService) {
