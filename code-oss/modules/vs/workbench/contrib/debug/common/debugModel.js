...
import { getUriFromSource, UNKNOWN_SOURCE_LABEL } from 'vs/workbench/contrib/debug/common/debugSource';
...
export class Breakpoint extends BaseBreakpoint {
    ...
    textFileService;
    uriIdentityService;
    constructor(_uri, _lineNumber, _column, enabled, condition, hitCondition, logMessage, _adapterData, textFileService, uriIdentityService, id = generateUuid()) {
...
let DebugModel = class DebugModel {
    ...
    _onDidChangeBreakpoints = new Emitter();
    _onDidChangeCallStack = new Emitter();
    _onDidChangeWatchExpressions = new Emitter();
    breakpoints;
    functionBreakpoints;
