...
import { DebugTaskRunner } from 'vs/workbench/contrib/debug/browser/debugTaskRunner';
import { CALLSTACK_VIEW_ID, CONTEXT_BREAKPOINTS_EXIST, CONTEXT_DEBUG_STATE, CONTEXT_DEBUG_TYPE, CONTEXT_DEBUG_UX, CONTEXT_DISASSEMBLY_VIEW_FOCUS, CONTEXT_IN_DEBUG_MODE, debuggerDisabledMessage, DEBUG_MEMORY_SCHEME, getStateLabel, REPL_VIEW_ID, VIEWLET_ID } from 'vs/workbench/contrib/debug/common/debug';
...
let DebugService = class DebugService {
    ...
    previousState;
    sessionCancellationTokens = new Map();
    activity;
    chosenEnvironments;
