...
export function renderExpressionValue(expressionOrValue, container, options) {
...
export function renderVariable(variable, data, showChanged, highlights, linkDetector) {
