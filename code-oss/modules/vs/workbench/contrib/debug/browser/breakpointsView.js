...
export function getExpandedBodySize(model, countLimit) {
...
export function getBreakpointMessageAndIcon(state, breakpointsActivated, breakpoint, labelService) {
