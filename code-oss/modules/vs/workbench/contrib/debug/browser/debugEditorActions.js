...
import { EditorAction, EditorAction2, registerEditorAction } from 'vs/editor/browser/editorExtensions';
...
class OpenDisassemblyViewAction extends EditorAction2 {
    static ID = 'editor.debug.action.openDisassemblyView';
    constructor() {
        super({
...
export class RunToCursorAction extends EditorAction {
    ...
    static LABEL = nls.localize('runToCursor', "Run to Cursor");
    constructor() {
        super({
...
export class SelectionToReplAction extends EditorAction {
    ...
    static LABEL = nls.localize('evaluateInDebugConsole', "Evaluate in Debug Console");
    constructor() {
        super({
...
export class SelectionToWatchExpressionsAction extends EditorAction {
    ...
    static LABEL = nls.localize('addToWatch', "Add to Watch");
    constructor() {
        super({
