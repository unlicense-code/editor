...
export const DEBUG_COMMAND_CATEGORY = { original: 'Debug', value: nls.localize('debug', 'Debug') };
...
KeybindingsRegistry.registerCommandAndKeybindingRule({
    ...
    mac: { primary: 1024 /* KeyMod.Shift */ | 2048 /* KeyMod.CtrlCmd */ | 89 /* KeyCode.BracketRight */ },
    handler: async (accessor, _, context) => {
...
KeybindingsRegistry.registerCommandAndKeybindingRule({
    ...
    mac: { primary: 1024 /* KeyMod.Shift */ | 2048 /* KeyMod.CtrlCmd */ | 87 /* KeyCode.BracketLeft */ },
    handler: async (accessor, _, context) => {
...
KeybindingsRegistry.registerCommandAndKeybindingRule({
    id: STEP_OVER_ID,
    weight: 200 /* KeybindingWeight.WorkbenchContrib */,
    primary: isWeb ? (512 /* KeyMod.Alt */ | 68 /* KeyCode.F10 */) : 68 /* KeyCode.F10 */,
...
KeybindingsRegistry.registerCommandAndKeybindingRule({
    ...
    handler: async (accessor, query) => {
        ...
        const viewlet = (await paneCompositeService.openPaneComposite(EXTENSIONS_VIEWLET_ID, 0 /* ViewContainerLocation.Sidebar */, true))?.getViewPaneContainer();
