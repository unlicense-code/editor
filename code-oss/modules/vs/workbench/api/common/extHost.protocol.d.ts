...
export declare type CommentThreadChanges<T = IRange> = Partial<{
    range: T;
    label: string;
...
export declare type GlobPattern = string | IRelativePattern;
 ...
 * use the numeric id.
 */
export declare type ExtHostTerminalIdentifier = number | string;
...
export declare type TransferQuickPickItemOrSeparator = TransferQuickPickItem | quickInput.IQuickPickSeparator;
...
export declare type WebviewHandle = string;
...
export interface ExtHostCustomEditorsShape {
    $resolveWebviewEditor(resource: UriComponents, newWebviewHandle: WebviewHandle, viewType: string, initData: {
        title: string;
...
export declare type INotebookCellStatusBarEntryDto = Dto<notebookCommon.INotebookCellStatusBarItem>;
...
export declare type ICellExecuteUpdateDto = ICellExecuteOutputEditDto | ICellExecuteOutputItemEditDto | ICellExecutionStateUpdateDto;
...
export declare type SCMRawResource = [
    number,
    UriComponents,
    [
...
export declare type SCMRawResourceSplice = [
    number,
    number,
    SCMRawResource[]
];
export declare type SCMRawResourceSplices = [
    number,
...
export declare type IInlayHintDto = CachedSessionItem<Dto<languages.InlayHint>>;
export declare type IInlayHintsDto = CachedSession<{
    hints: IInlayHintDto[];
}>;
export declare type ILocationDto = Dto<languages.Location>;
export declare type ILocationLinkDto = Dto<languages.LocationLink>;
export declare type IWorkspaceSymbolDto = CachedSessionItem<Dto<IWorkspaceSymbol>>;
export declare type IWorkspaceSymbolsDto = CachedSession<{
...
export declare type ICellEditOperationDto = notebookCommon.ICellPartialMetadataEdit | notebookCommon.IDocumentMetadataEdit | {
    editType: notebookCommon.CellEditType.Replace;
    index: number;
    count: number;
    cells: NotebookCellDataDto[];
};
export declare type IWorkspaceCellEditDto = Dto<Omit<notebookCommon.IWorkspaceNotebookCellEdit, 'cellEdit'>> & {
    cellEdit: ICellEditOperationDto;
};
export declare type IWorkspaceFileEditDto = Dto<languages.IWorkspaceFileEdit>;
export declare type IWorkspaceTextEditDto = Dto<languages.IWorkspaceTextEdit>;
export interface IWorkspaceEditDto {
    edits: Array<IWorkspaceFileEditDto | IWorkspaceTextEditDto | IWorkspaceCellEditDto>;
}
export declare type ICommandDto = {
    $ident?: string;
} & languages.Command;
...
declare type CachedSessionItem<T> = T & {
    cacheId?: ChainedCacheId;
};
declare type CachedSession<T> = T & {
    cacheId?: CacheId;
};
export declare type ILinksListDto = CachedSession<{
    links: ILinkDto[];
}>;
export declare type ILinkDto = CachedSessionItem<Dto<languages.ILink>>;
export declare type ICodeLensListDto = CachedSession<{
    lenses: ICodeLensDto[];
}>;
export declare type ICodeLensDto = CachedSessionItem<Dto<languages.CodeLens>>;
export declare type ICallHierarchyItemDto = Dto<CallHierarchyItem>;
...
export declare type ITypeHierarchyItemDto = Dto<TypeHierarchyItem>;
...
export interface ExtHostTelemetryShape {
    $initializeTelemetryLevel(level: TelemetryLevel, debugLoggingOnly: boolean, productConfig?: {
        usage: boolean;
        error: boolean;
    }): void;
...
export declare type IDebugSessionDto = IDebugSessionFullDto | DebugSessionUUID;
...
export declare type DecorationData = [boolean, string, string | ThemeIcon, ThemeColor];
export declare type DecorationReply = {
...
export declare type INotebookEditorViewColumnInfo = Record<string, number>;
...
export interface ExtHostTestingShape {
    $runControllerTests(req: RunTestForControllerRequest[], token: CancellationToken): Promise<{
        error?: string;
    }[]>;
...
export declare const MainContext: {
    MainThreadAuthentication: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<MainThreadAuthenticationShape>;
    MainThreadBulkEdits: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<MainThreadBulkEditsShape>;
    MainThreadClipboard: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<MainThreadClipboardShape>;
    MainThreadCommands: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<MainThreadCommandsShape>;
    MainThreadComments: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<MainThreadCommentsShape>;
    MainThreadConfiguration: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<MainThreadConfigurationShape>;
    MainThreadConsole: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<MainThreadConsoleShape>;
    MainThreadDebugService: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<MainThreadDebugServiceShape>;
    MainThreadDecorations: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<MainThreadDecorationsShape>;
    MainThreadDiagnostics: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<MainThreadDiagnosticsShape>;
    MainThreadDialogs: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<MainThreadDiaglogsShape>;
    MainThreadDocuments: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<MainThreadDocumentsShape>;
    MainThreadDocumentContentProviders: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<MainThreadDocumentContentProvidersShape>;
    MainThreadTextEditors: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<MainThreadTextEditorsShape>;
    MainThreadEditorInsets: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<MainThreadEditorInsetsShape>;
    MainThreadEditorTabs: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<MainThreadEditorTabsShape>;
    MainThreadErrors: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<MainThreadErrorsShape>;
    MainThreadTreeViews: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<MainThreadTreeViewsShape>;
    MainThreadDownloadService: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<MainThreadDownloadServiceShape>;
    MainThreadKeytar: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<MainThreadKeytarShape>;
    MainThreadLanguageFeatures: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<MainThreadLanguageFeaturesShape>;
    MainThreadLanguages: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<MainThreadLanguagesShape>;
    MainThreadLogger: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<MainThreadLoggerShape>;
    MainThreadMessageService: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<MainThreadMessageServiceShape>;
    MainThreadOutputService: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<MainThreadOutputServiceShape>;
    MainThreadProgress: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<MainThreadProgressShape>;
    MainThreadQuickOpen: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<MainThreadQuickOpenShape>;
    MainThreadStatusBar: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<MainThreadStatusBarShape>;
    MainThreadSecretState: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<MainThreadSecretStateShape>;
    MainThreadStorage: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<MainThreadStorageShape>;
    MainThreadTelemetry: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<MainThreadTelemetryShape>;
    MainThreadTerminalService: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<MainThreadTerminalServiceShape>;
    MainThreadWebviews: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<MainThreadWebviewsShape>;
    MainThreadWebviewPanels: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<MainThreadWebviewPanelsShape>;
    MainThreadWebviewViews: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<MainThreadWebviewViewsShape>;
    MainThreadCustomEditors: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<MainThreadCustomEditorsShape>;
    MainThreadUrls: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<MainThreadUrlsShape>;
    MainThreadUriOpeners: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<MainThreadUriOpenersShape>;
    MainThreadWorkspace: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<MainThreadWorkspaceShape>;
    MainThreadFileSystem: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<MainThreadFileSystemShape>;
    MainThreadExtensionService: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<MainThreadExtensionServiceShape>;
    MainThreadSCM: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<MainThreadSCMShape>;
    MainThreadSearch: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<MainThreadSearchShape>;
    MainThreadTask: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<MainThreadTaskShape>;
    MainThreadWindow: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<MainThreadWindowShape>;
    MainThreadLabelService: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<MainThreadLabelServiceShape>;
    MainThreadNotebook: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<MainThreadNotebookShape>;
    MainThreadNotebookDocuments: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<MainThreadNotebookDocumentsShape>;
    MainThreadNotebookEditors: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<MainThreadNotebookEditorsShape>;
    MainThreadNotebookKernels: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<MainThreadNotebookKernelsShape>;
    MainThreadNotebookRenderers: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<MainThreadNotebookRenderersShape>;
    MainThreadInteractive: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<MainThreadInteractiveShape>;
    MainThreadTheming: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<MainThreadThemingShape>;
    MainThreadTunnelService: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<MainThreadTunnelServiceShape>;
    MainThreadTimeline: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<MainThreadTimelineShape>;
    MainThreadTesting: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<MainThreadTestingShape>;
    MainThreadLocalization: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<MainThreadLocalizationShape>;
};
export declare const ExtHostContext: {
    ExtHostCommands: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<ExtHostCommandsShape>;
    ExtHostConfiguration: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<ExtHostConfigurationShape>;
    ExtHostDiagnostics: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<ExtHostDiagnosticsShape>;
    ExtHostDebugService: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<ExtHostDebugServiceShape>;
    ExtHostDecorations: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<ExtHostDecorationsShape>;
    ExtHostDocumentsAndEditors: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<ExtHostDocumentsAndEditorsShape>;
    ExtHostDocuments: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<ExtHostDocumentsShape>;
    ExtHostDocumentContentProviders: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<ExtHostDocumentContentProvidersShape>;
    ExtHostDocumentSaveParticipant: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<ExtHostDocumentSaveParticipantShape>;
    ExtHostEditors: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<ExtHostEditorsShape>;
    ExtHostTreeViews: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<ExtHostTreeViewsShape>;
    ExtHostFileSystem: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<ExtHostFileSystemShape>;
    ExtHostFileSystemInfo: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<ExtHostFileSystemInfoShape>;
    ExtHostFileSystemEventService: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<ExtHostFileSystemEventServiceShape>;
    ExtHostLanguages: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<ExtHostLanguagesShape>;
    ExtHostLanguageFeatures: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<ExtHostLanguageFeaturesShape>;
    ExtHostQuickOpen: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<ExtHostQuickOpenShape>;
    ExtHostExtensionService: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<ExtHostExtensionServiceShape>;
    ExtHostLogLevelServiceShape: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<ExtHostLogLevelServiceShape>;
    ExtHostTerminalService: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<ExtHostTerminalServiceShape>;
    ExtHostSCM: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<ExtHostSCMShape>;
    ExtHostSearch: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<ExtHostSearchShape>;
    ExtHostTask: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<ExtHostTaskShape>;
    ExtHostWorkspace: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<ExtHostWorkspaceShape>;
    ExtHostWindow: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<ExtHostWindowShape>;
    ExtHostWebviews: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<ExtHostWebviewsShape>;
    ExtHostWebviewPanels: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<ExtHostWebviewPanelsShape>;
    ExtHostCustomEditors: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<ExtHostCustomEditorsShape>;
    ExtHostWebviewViews: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<ExtHostWebviewViewsShape>;
    ExtHostEditorInsets: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<ExtHostEditorInsetsShape>;
    ExtHostEditorTabs: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<IExtHostEditorTabsShape>;
    ExtHostProgress: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<ExtHostProgressShape>;
    ExtHostComments: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<ExtHostCommentsShape>;
    ExtHostSecretState: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<ExtHostSecretStateShape>;
    ExtHostStorage: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<ExtHostStorageShape>;
    ExtHostUrls: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<ExtHostUrlsShape>;
    ExtHostUriOpeners: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<ExtHostUriOpenersShape>;
    ExtHostOutputService: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<ExtHostOutputServiceShape>;
    ExtHosLabelService: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<ExtHostLabelServiceShape>;
    ExtHostNotebook: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<ExtHostNotebookShape>;
    ExtHostNotebookDocuments: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<ExtHostNotebookDocumentsShape>;
    ExtHostNotebookEditors: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<ExtHostNotebookEditorsShape>;
    ExtHostNotebookKernels: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<ExtHostNotebookKernelsShape>;
    ExtHostNotebookRenderers: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<ExtHostNotebookRenderersShape>;
    ExtHostInteractive: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<ExtHostInteractiveShape>;
    ExtHostTheming: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<ExtHostThemingShape>;
    ExtHostTunnelService: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<ExtHostTunnelServiceShape>;
    ExtHostAuthentication: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<ExtHostAuthenticationShape>;
    ExtHostTimeline: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<ExtHostTimelineShape>;
    ExtHostTesting: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<ExtHostTestingShape>;
    ExtHostTelemetry: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<ExtHostTelemetryShape>;
    ExtHostLocalization: import("vs/workbench/services/extensions/common/proxyIdentifier").ProxyIdentifier<ExtHostLocalizationShape>;
};
export {};
