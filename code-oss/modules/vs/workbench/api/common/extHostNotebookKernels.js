...
let ExtHostNotebookKernels = class ExtHostNotebookKernels {
    ...
    _kernelDetectionTask = new Map();
    _kernelDetectionTaskHandlePool = 0;
    _kernelSourceActionProviders = new Map();
    _kernelSourceActionProviderHandlePool = 0;
    _kernelSourceActionProviderCache = new Cache('NotebookKernelSourceActionProviderCache');
    _kernelData = new Map();
    _handlePool = 0;
...
class NotebookCellExecutionTask extends Disposable {
    ...
    _state = NotebookCellExecutionTaskState.Init;
