...
import { NotificationsModel, NotificationViewItem } from 'vs/workbench/common/notifications';
...
suite('Notifications', () => {
    ...
    test('Model', () => {
        ...
        const item1 = { severity: Severity.Error, message: 'Error Message', actions: { primary: [new Action('id', 'label')] } };
