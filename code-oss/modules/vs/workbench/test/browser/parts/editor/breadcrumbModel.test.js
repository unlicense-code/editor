...
suite('Breadcrumb Model', function () {
    ...
    test('only uri, inside workspace', function () {
        const model = new BreadcrumbsModel(URI.parse('foo:/bar/baz/ws/some/path/file.ts'), undefined, configService, workspaceService, new class extends mock() {
        });
    ...
    test('only uri, outside workspace', function () {
        const model = new BreadcrumbsModel(URI.parse('foo:/outside/file.ts'), undefined, configService, workspaceService, new class extends mock() {
        });
        const elements = model.getElements();
