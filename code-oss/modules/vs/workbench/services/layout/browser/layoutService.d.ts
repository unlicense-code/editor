...
export declare const IWorkbenchLayoutService: import("vs/platform/instantiation/common/instantiation").ServiceIdentifier<IWorkbenchLayoutService>;
...
export declare type PanelAlignment = 'left' | 'center' | 'right' | 'justify';
