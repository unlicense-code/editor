...
import { SearchError, SearchErrorCode, serializeSearchError } from 'vs/workbench/services/search/common/search';
import { Range } from 'vs/workbench/services/search/common/searchExtTypes';
import { RegExpParser, RegExpVisitor } from 'vscode-regexpp';
import { rgPath } from '@vscode/ripgrep';
import { anchorGlob, createTextSearchResult } from './ripgrepSearchUtils';
...
export function buildRegexParseError(lines) {
...
function getRgArgs(query, options) {
    ...
    const { doubleStarIncludes, otherIncludes } = groupBy(options.includes, (include) => include.startsWith('**') ? 'doubleStarIncludes' : 'otherIncludes');
 ...
 */
export function spreadGlobComponents(globArg) {
