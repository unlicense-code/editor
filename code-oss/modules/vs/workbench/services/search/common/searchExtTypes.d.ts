 ...
 */
export declare type GlobPattern = string | RelativePattern;
/**
 ...
 */
export declare type GlobString = string;
/**
...
export declare type TextSearchResult = TextSearchMatch | TextSearchContext;
/**
