...
export declare const RemoteExtensionLogFileName = "remoteagent";
export declare const IRemoteAgentService: import("vs/platform/instantiation/common/instantiation").ServiceIdentifier<IRemoteAgentService>;
