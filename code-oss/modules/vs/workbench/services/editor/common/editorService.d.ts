...
import { ICloseEditorOptions, IEditorGroup } from 'vs/workbench/services/editor/common/editorGroupsService';
import { URI } from 'vs/base/common/uri';
import { IGroupModelChangeEvent } from 'vs/workbench/common/editor/editorGroupModel';
export declare const IEditorService: import("vs/platform/instantiation/common/instantiation").ServiceIdentifier<IEditorService>;
/**
...
export declare type PreferredGroup = IEditorGroup | GroupIdentifier | SIDE_GROUP_TYPE | ACTIVE_GROUP_TYPE;
