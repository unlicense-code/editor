...
import { SideBySideEditor, isEditorInputWithOptions, EditorResourceAccessor, isResourceDiffEditorInput, isResourceEditorInput, isEditorInput, isEditorInputWithOptionsAndGroup, isResourceMergeEditorInput } from 'vs/workbench/common/editor';
...
import { IEditorGroupsService, isEditorReplacement } from 'vs/workbench/services/editor/common/editorGroupsService';
import { IEditorService, isPreferredGroup } from 'vs/workbench/services/editor/common/editorService';
import { IConfigurationService } from 'vs/platform/configuration/common/configuration';
import { Disposable, dispose, DisposableStore } from 'vs/base/common/lifecycle';
import { coalesce, distinct } from 'vs/base/common/arrays';
import { isCodeEditor, isDiffEditor, isCompositeEditor } from 'vs/editor/browser/editorBrowser';
...
let EditorService = class EditorService extends Disposable {
    ...
    editorsObserver = this._register(this.instantiationService.createInstance(EditorsObserver));
...
registerSingleton(IEditorService, EditorService, 0 /* InstantiationType.Eager */);
