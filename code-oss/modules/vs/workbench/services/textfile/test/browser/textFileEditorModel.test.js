...
import { snapshotToString, isTextFileEditorModel } from 'vs/workbench/services/textfile/common/textfiles';
...
suite('Files - TextFileEditorModel', () => {
    ...
    async function testBackupAndRestore(resourceA, resourceB, contents) {
        const originalModel = instantiationService.createInstance(TextFileEditorModel, resourceA, 'utf8', undefined);
        ...
        const modelRestored = instantiationService.createInstance(TextFileEditorModel, modelRestoredIdentifier.resource, 'utf8', undefined);
