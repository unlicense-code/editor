...
export declare const IConfigurationResolverService: import("vs/platform/instantiation/common/instantiation").ServiceIdentifier<IConfigurationResolverService>;
...
export declare type ConfiguredInput = PromptStringInputInfo | PickStringInputInfo | CommandInputInfo;
...
export declare class VariableError extends Error {
