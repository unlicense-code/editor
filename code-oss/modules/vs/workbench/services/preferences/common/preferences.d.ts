...
export declare type IGroupFilter = (group: ISettingsGroup) => boolean | null;
export declare type ISettingMatcher = (setting: ISetting, group: ISettingsGroup) => {
    matches: IRange[];
    matchType: SettingMatchType;
    score: number;
} | null;
...
export declare const IPreferencesService: import("vs/platform/instantiation/common/instantiation").ServiceIdentifier<IPreferencesService>;
