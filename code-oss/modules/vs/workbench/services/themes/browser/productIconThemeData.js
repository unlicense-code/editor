...
import { ExtensionData } from 'vs/workbench/services/themes/common/workbenchThemeService';
...
import { getIconRegistry, IconFontDefinition } from 'vs/platform/theme/common/iconRegistry';
...
export class ProductIconThemeData {
    ...
    extensionData;
    watch;
    iconThemeDocument = { iconDefinitions: new Map() };
    styleSheetContent;
