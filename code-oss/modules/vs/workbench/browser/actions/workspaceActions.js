...
import { IWorkspaceContextService, hasWorkspaceFileExtension } from 'vs/platform/workspace/common/workspace';
...
export class OpenFileFolderAction extends Action2 {
    ...
    static LABEL = { value: localize('openFileFolder', "Open..."), original: 'Open...' };
    constructor() {
        super({
