...
class OpenDocumentationUrlAction extends Action2 {
    ...
    static AVAILABLE = !!product.documentationUrl;
    constructor() {
        super({
...
class OpenTwitterUrlAction extends Action2 {
    static ID = 'workbench.action.openTwitterUrl';
    static AVAILABLE = !!product.twitterUrl;
    constructor() {
        super({
...
class OpenLicenseUrlAction extends Action2 {
    ...
    static AVAILABLE = !!product.licenseUrl;
    constructor() {
        super({
