...
import { isSingleFolderWorkspaceIdentifier, isWorkspaceIdentifier, IWorkspaceContextService } from 'vs/platform/workspace/common/workspace';
...
export class BrowserMain extends Disposable {
    ...
    async initServices() {
        ...
        if (isProfilesEnablementConfigured) {
            ...
            this._register(configurationService.onDidChangeConfiguration(e => {
                if (e.source !== 7 /* ConfigurationTarget.DEFAULT */ && e.affectsConfiguration(PROFILES_ENABLEMENT_CONFIG)) {
    ...
    async registerFileSystemProviders(environmentService, fileService, remoteAgentService, logService, loggerService, logsPath) {
