...
import { ViewContainerLocationToString } from 'vs/workbench/common/views';
...
export class ToggleAuxiliaryBarAction extends Action2 {
    ...
    static LABEL = localize('toggleAuxiliaryBar', "Toggle Secondary Side Bar Visibility");
    constructor() {
        super({
...
registerAction2(class FocusAuxiliaryBarAction extends Action2 {
    ...
    static LABEL = localize('focusAuxiliaryBar', "Focus into Secondary Side Bar");
    constructor() {
        super({
