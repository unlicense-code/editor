...
import { TextBadge, NumberBadge, IconBadge, ProgressBadge } from 'vs/workbench/services/activity/common/activity';
...
export class ActivityAction extends Action {
    ...
    _onDidChangeBadge = this._register(new Emitter());
    onDidChangeBadge = this._onDidChangeBadge.event;
    badge;
    clazz;
