...
import { TEXT_DIFF_EDITOR_ID, EditorExtensions, isEditorInput, isTextEditorViewState } from 'vs/workbench/common/editor';
...
let TextDiffEditor = class TextDiffEditor extends AbstractTextEditor {
    ...
    diffEditorControl = undefined;
    diffNavigator;
    diffNavigatorDisposables = this._register(new DisposableStore());
    ...
    getConfigurationOverrides() {
        const readOnly = this.input instanceof DiffEditorInput && this.input.modified.hasCapability(2 /* EditorInputCapabilities.Readonly */);
        return {
            ...super.getConfigurationOverrides(),
            readOnly,
            originalEditable: this.input instanceof DiffEditorInput && !this.input.original.hasCapability(2 /* EditorInputCapabilities.Readonly */),
    ...
    updateReadonly(input) {
        if (input instanceof DiffEditorInput) {
            this.diffEditorControl?.updateOptions({
                readOnly: input.hasCapability(2 /* EditorInputCapabilities.Readonly */),
