...
import { addDisposableListener, DragAndDropObserver, EventType, isAncestor } from 'vs/base/browser/dom';
...
import { combinedDisposable, dispose, toDisposable } from 'vs/base/common/lifecycle';
...
import { IViewDescriptorService, IViewsService, ViewContainerLocationToString, ViewVisibilityState } from 'vs/workbench/common/views';
...
let ViewPaneContainer = class ViewPaneContainer extends Component {
    ...
    create(parent) {
        ...
        this._register(addDisposableListener(parent, TouchEventType.Contextmenu, (e) => this.showContextMenu(new StandardMouseEvent(e))));
    ...
    addPane(pane, size, index = this.paneItems.length - 1) {
        ...
        const paneStyler = attachStyler(this.themeService, {
