    ...
    suite('inlineCompletionToGhostText', () => {
        function getOutput(text, suggestion) {
            ...
            for (const option of options) {
                result[option] = inlineCompletionToGhostText({ insertText: suggestion, filterText: suggestion, snippetInfo: undefined, range, additionalTextEdits: [], }, tempModel, option)?.render(cleanedText, true);
            }
            tempModel.dispose();
