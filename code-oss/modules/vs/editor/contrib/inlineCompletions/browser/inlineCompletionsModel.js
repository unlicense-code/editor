...
import { BaseGhostTextWidgetModel, GhostTextReplacement } from 'vs/editor/contrib/inlineCompletions/browser/ghostText';
import { ICommandService } from 'vs/platform/commands/common/commands';
import { inlineSuggestCommitId } from 'vs/editor/contrib/inlineCompletions/browser/consts';
import { inlineCompletionToGhostText } from 'vs/editor/contrib/inlineCompletions/browser/inlineCompletionToGhostText';
...
let InlineCompletionsModel = class InlineCompletionsModel extends Disposable {
    ...
    completionSession = this._register(new MutableDisposable());
    active = false;
    disposed = false;
    debounceValue = this.debounceService.for(this.languageFeaturesService.inlineCompletionsProvider, 'InlineCompletionsDebounce', { min: 50, max: 50 });
...
export class InlineCompletionsSession extends BaseGhostTextWidgetModel {
    ...
    updateSoon = this._register(new RunOnceScheduler(() => {
    ...
    currentlySelectedCompletionId = undefined;
