...
import { minimizeInlineCompletion, normalizedInlineCompletionsEquals } from './inlineCompletionToGhostText';
export class SuggestWidgetInlineCompletionProvider extends Disposable {
    ...
    _isActive = false;
    _currentSuggestItemInfo = undefined;
    ...
    setInactiveDelayed = this._register(new RunOnceScheduler(() => {
