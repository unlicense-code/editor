...
import { createCancelablePromise, first, timeout } from 'vs/base/common/async';
import { CancellationToken } from 'vs/base/common/cancellation';
import { onUnexpectedError, onUnexpectedExternalError } from 'vs/base/common/errors';
import { Disposable, DisposableStore } from 'vs/base/common/lifecycle';
import { EditorAction, registerEditorAction, registerEditorContribution, registerModelAndPositionCommand } from 'vs/editor/browser/editorExtensions';
...
class WordHighlighter {
    ...
    static _WRITE_OPTIONS = ModelDecorationOptions.register({
    ...
    static _TEXT_OPTIONS = ModelDecorationOptions.register({
    ...
    static _REGULAR_OPTIONS = ModelDecorationOptions.register({
