...
import { createCancelablePromise, Delayer, RunOnceScheduler } from 'vs/base/common/async';
...
import { EditorAction, registerEditorAction, registerEditorContribution, registerInstantiatedEditorAction } from 'vs/editor/browser/editorExtensions';
...
let FoldingController = class FoldingController extends Disposable {
    ...
    mouseDownInfo;
    _onDidChangeFoldingLimit = new Emitter();
    onDidChangeFoldingLimit = this._onDidChangeFoldingLimit.event;
    _foldingLimitInfo;
    get foldingLimitInfo() {
