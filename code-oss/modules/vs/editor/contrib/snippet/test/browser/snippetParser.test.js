...
import { Choice, FormatString, Placeholder, Scanner, SnippetParser, Text, TextmateSnippet, Transform, Variable } from 'vs/editor/contrib/snippet/browser/snippetParser';
suite('SnippetParser', () => {
    test('Scanner', () => {
