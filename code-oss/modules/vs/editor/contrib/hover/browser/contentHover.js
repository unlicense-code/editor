...
import { HoverParticipantRegistry, HoverRangeAnchor } from 'vs/editor/contrib/hover/browser/hoverTypes';
...
let ContentHoverController = class ContentHoverController extends Disposable {
    ...
    _keybindingService;
    _participants;
    _widget = this._register(this._instantiationService.createInstance(ContentHoverWidget, this._editor));
    _computer;
    _hoverOperation;
    _currentResult = null;
    ...
    _renderMessages(anchor, messages) {
        ...
        if (fragment.hasChildNodes()) {
            ...
            this._widget.showAt(fragment, new ContentHoverVisibleData(colorPicker, showAtPosition, showAtSecondaryPosition, this._editor.getOption(54 /* EditorOption.hover */).above, this._computer.shouldFocus, this._computer.source, isBeforeContent, anchor.initialMousePosX, anchor.initialMousePosY, disposables));
        }
        else {
            disposables.dispose();
        }
...
class ContentHoverVisibleData {
    ...
    initialMousePosY;
    disposables;
    closestMouseDistance = undefined;
...
let ContentHoverWidget = class ContentHoverWidget extends Disposable {
    _editor;
    _contextKeyService;
    static ID = 'editor.contrib.contentHoverWidget';
    allowEditorOverflow = true;
    _hoverVisibleKey = EditorContextKeys.hoverVisible.bindTo(this._contextKeyService);
...
class ContentHoverComputer {
    ...
    _source = 0 /* HoverStartSource.Mouse */;
    get source() { return this._source; }
    set source(value) { this._source = value; }
    _insistOnKeepingHoverVisible = false;
