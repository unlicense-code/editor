...
suite('Content Hover', () => {
    test('issue #151235: Gitlens hover shows up in the wrong place', () => {
        ...
        withTestCodeEditor(text, {}, (editor) => {
            const actual = ContentHoverController.computeHoverRanges(editor, new Range(5, 5, 5, 5), [{ range: new Range(4, 1, 5, 6) }]);
    ...
    test('issue #95328: Hover placement with word-wrap', () => {
        ...
        withTestCodeEditor(text, opts, (editor) => {
            const actual = ContentHoverController.computeHoverRanges(editor, new Range(1, 8, 1, 8), [{ range: new Range(1, 1, 1, 15) }]);
            assert.deepStrictEqual(actual, {
