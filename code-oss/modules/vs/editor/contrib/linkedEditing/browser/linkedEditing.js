...
import { createCancelablePromise, Delayer, first } from 'vs/base/common/async';
...
import { EditorAction, EditorCommand, registerEditorAction, registerEditorCommand, registerEditorContribution, registerModelAndPositionCommand } from 'vs/editor/browser/editorExtensions';
...
let LinkedEditingContribution = class LinkedEditingContribution extends Disposable {
    ...
    _currentDecorations; // The one at index 0 is the reference one
    _syncRangesToken = 0;
