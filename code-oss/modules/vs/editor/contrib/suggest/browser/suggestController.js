...
import { DisposableStore, dispose, MutableDisposable, toDisposable } from 'vs/base/common/lifecycle';
...
let SuggestController = class SuggestController {
    ...
    constructor(editor, _memoryService, _commandService, _contextKeyService, _instantiationService, _logService, _telemetryService) {
        ...
        this._toDispose.add(this.model.onDidSuggest(e => {
            ...
            this.widget.value.showSuggestions(e.completionModel, index, e.isFrozen, e.auto, e.auto && !this.editor.getOption(108 /* EditorOption.suggest */).selectQuickSuggestions);
        }));
