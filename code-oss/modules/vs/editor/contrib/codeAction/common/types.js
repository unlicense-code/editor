...
export class CodeActionKind {
    value;
    static sep = '.';
    static None = new CodeActionKind('@@none@@'); // Special code action that contains nothing
    ...
    static RefactorMove = CodeActionKind.Refactor.append('move');
    ...
    static SurroundWith = CodeActionKind.Refactor.append('surround');
    constructor(value) {
        this.value = value;
    }
    equals(other) {
