...
suite('ParameterHintsModel', () => {
    ...
    let registry = new LanguageFeatureRegistry();
    setup(() => {
        disposables.clear();
    ...
    function createMockEditor(fileContents) {
        ...
        const editor = createTestCodeEditor(textModel, {
            serviceCollection: new ServiceCollection([ITelemetryService, NullTelemetryService], [IStorageService, new InMemoryStorageService()])
        });
