...
import { Emitter, EventDeliveryQueue } from 'vs/base/common/event';
import { hash } from 'vs/base/common/hash';
import { Disposable, dispose, DisposableMap } from 'vs/base/common/lifecycle';
...
let CodeEditorWidget = class CodeEditorWidget extends Disposable {
    ...
    //#region Eventing
    _deliveryQueue = new EventDeliveryQueue();
    ...
    _onDidAttemptReadOnlyEdit = this._register(new Emitter({ deliveryQueue: this._deliveryQueue }));
    ...
    _onWillType = this._register(new Emitter({ deliveryQueue: this._deliveryQueue }));
    onWillType = this._onWillType.event;
    _onDidType = this._register(new Emitter({ deliveryQueue: this._deliveryQueue }));
    onDidType = this._onDidType.event;
    _onDidCompositionStart = this._register(new Emitter({ deliveryQueue: this._deliveryQueue }));
    onDidCompositionStart = this._onDidCompositionStart.event;
    _onDidCompositionEnd = this._register(new Emitter({ deliveryQueue: this._deliveryQueue }));
    onDidCompositionEnd = this._onDidCompositionEnd.event;
    _onDidPaste = this._register(new Emitter({ deliveryQueue: this._deliveryQueue }));
    onDidPaste = this._onDidPaste.event;
    _onMouseUp = this._register(new Emitter({ deliveryQueue: this._deliveryQueue }));
    onMouseUp = this._onMouseUp.event;
    _onMouseDown = this._register(new Emitter({ deliveryQueue: this._deliveryQueue }));
    onMouseDown = this._onMouseDown.event;
    _onMouseDrag = this._register(new Emitter({ deliveryQueue: this._deliveryQueue }));
    onMouseDrag = this._onMouseDrag.event;
    _onMouseDrop = this._register(new Emitter({ deliveryQueue: this._deliveryQueue }));
    onMouseDrop = this._onMouseDrop.event;
    _onMouseDropCanceled = this._register(new Emitter({ deliveryQueue: this._deliveryQueue }));
    onMouseDropCanceled = this._onMouseDropCanceled.event;
    _onDropIntoEditor = this._register(new Emitter({ deliveryQueue: this._deliveryQueue }));
    onDropIntoEditor = this._onDropIntoEditor.event;
    _onContextMenu = this._register(new Emitter({ deliveryQueue: this._deliveryQueue }));
    onContextMenu = this._onContextMenu.event;
    _onMouseMove = this._register(new Emitter({ deliveryQueue: this._deliveryQueue }));
    onMouseMove = this._onMouseMove.event;
    _onMouseLeave = this._register(new Emitter({ deliveryQueue: this._deliveryQueue }));
    onMouseLeave = this._onMouseLeave.event;
    _onMouseWheel = this._register(new Emitter({ deliveryQueue: this._deliveryQueue }));
    onMouseWheel = this._onMouseWheel.event;
    _onKeyUp = this._register(new Emitter({ deliveryQueue: this._deliveryQueue }));
    onKeyUp = this._onKeyUp.event;
    _onKeyDown = this._register(new Emitter({ deliveryQueue: this._deliveryQueue }));
    ...
    getContribution(id) {
        ...
        return (entry instanceof IdleValue ? entry.value : entry);
    }
    getActions() {
