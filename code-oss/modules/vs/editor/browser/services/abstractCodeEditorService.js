...
import { DisposableStore, Disposable, toDisposable } from 'vs/base/common/lifecycle';
...
let AbstractCodeEditorService = class AbstractCodeEditorService extends Disposable {
    ...
    _diffEditors;
    _globalStyleSheet;
    _decorationOptionProviders = new Map();
    _editorStyleSheets = new Map();
