...
import { CharWidthRequest, readCharWidths } from 'vs/editor/browser/config/charWidthReader';
import { EditorFontLigatures } from 'vs/editor/common/config/editorOptions';
import { FontInfo, SERIALIZED_FONT_INFO_VERSION } from 'vs/editor/common/config/fontInfo';
export class FontMeasurementsImpl extends Disposable {
    _cache;
    _evictUntrustedReadingsTimeout;
