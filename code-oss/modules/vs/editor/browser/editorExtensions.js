...
(function (EditorContributionInstantiation) {
     ...
     */
    EditorContributionInstantiation[EditorContributionInstantiation["Idle"] = 1] = "Idle";
...
export function registerEditorContribution(id, ctor, instantiation = EditorContributionInstantiation.Eager) {
...
class EditorContributionRegistry {
    ...
    registerEditorContribution(id, ctor, instantiation = EditorContributionInstantiation.Eager) {
