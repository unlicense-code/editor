...
import { createModelLineProjection } from 'vs/editor/common/viewModel/modelLineProjection';
...
suite('Editor ViewModel - SplitLinesCollection', () => {
    ...
    function withSplitLinesCollection(text, callback) {
        ...
        const wrappingInfo = config.options.get(134 /* EditorOption.wrappingInfo */);
        const fontInfo = config.options.get(45 /* EditorOption.fontInfo */);
        const wordWrapBreakAfterCharacters = config.options.get(121 /* EditorOption.wordWrapBreakAfterCharacters */);
        const wordWrapBreakBeforeCharacters = config.options.get(122 /* EditorOption.wordWrapBreakBeforeCharacters */);
        const wrappingIndent = config.options.get(126 /* EditorOption.wrappingIndent */);
        ...
        const linesCollection = new ViewModelLinesFromProjectedModel(1, model, lineBreaksComputerFactory, lineBreaksComputerFactory, fontInfo, model.getOptions().tabSize, 'simple', wrappingInfo.wrappingColumn, wrappingIndent);
...
suite('SplitLinesCollection', () => {
    ...
    function withSplitLinesCollection(model, wordWrap, wordWrapColumn, callback) {
        ...
        const wrappingInfo = configuration.options.get(134 /* EditorOption.wrappingInfo */);
        const fontInfo = configuration.options.get(45 /* EditorOption.fontInfo */);
        const wordWrapBreakAfterCharacters = configuration.options.get(121 /* EditorOption.wordWrapBreakAfterCharacters */);
        const wordWrapBreakBeforeCharacters = configuration.options.get(122 /* EditorOption.wordWrapBreakBeforeCharacters */);
        const wrappingIndent = configuration.options.get(126 /* EditorOption.wrappingIndent */);
        const lineBreaksComputerFactory = new MonospaceLineBreaksComputerFactory(wordWrapBreakBeforeCharacters, wordWrapBreakAfterCharacters);
        const linesCollection = new ViewModelLinesFromProjectedModel(1, model, lineBreaksComputerFactory, lineBreaksComputerFactory, fontInfo, model.getOptions().tabSize, 'simple', wrappingInfo.wrappingColumn, wrappingIndent);
