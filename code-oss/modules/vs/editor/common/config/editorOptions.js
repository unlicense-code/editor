...
class WrappingStrategy extends BaseEditorOption {
    constructor() {
        super(127 /* EditorOption.wrappingStrategy */, 'wrappingStrategy', 'simple', {
...
class WrappingIndentOption extends BaseEditorOption {
    constructor() {
        super(126 /* EditorOption.wrappingIndent */, 'wrappingIndent', 1 /* WrappingIndent.Same */, {
...
export const EditorOptions = {
    ...
    linkedEditing: register(new EditorBooleanOption(63 /* EditorOption.linkedEditing */, 'linkedEditing', false, { description: nls.localize('linkedEditing', "Controls whether the editor has linked editing enabled. Depending on the language, related symbols such as HTML tags, are updated while editing.") })),
