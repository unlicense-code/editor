...
export class TokenizationTextModelPart extends TextModelPart {
    ...
    _backgroundTokenizationState = 0 /* BackgroundTokenizationState.Uninitialized */;
    ...
    _onBackgroundTokenizationStateChanged = this._register(new Emitter());
    onBackgroundTokenizationStateChanged = this._onBackgroundTokenizationStateChanged.event;
