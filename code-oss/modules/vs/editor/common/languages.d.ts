 ...
 * @internal
 */
export declare type InlineValue = InlineValueText | InlineValueVariableLookup | InlineValueExpression;
/**
...
export declare namespace CompletionItemKinds {
     ...
     * @internal
     */
    function toIcon(kind: CompletionItemKind): CSSIcon;
    /**
     * @internal
     */
...
export declare namespace SymbolKinds {
     ...
     * @internal
     */
    function toIcon(kind: SymbolKind): CSSIcon;
}
 ...
 * @internal
 */
export declare const TokenizationRegistry: ITokenizationRegistry;
/**
 * @internal
 */
