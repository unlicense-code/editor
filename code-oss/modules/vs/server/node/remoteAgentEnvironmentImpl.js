...
import { ContextKeyExpr, ContextKeyDefinedExpr, ContextKeyNotExpr, ContextKeyEqualsExpr, ContextKeyNotEqualsExpr, ContextKeyRegexExpr, ContextKeyInExpr, ContextKeyGreaterExpr, ContextKeyGreaterEqualsExpr, ContextKeySmallerExpr, ContextKeySmallerEqualsExpr, ContextKeyNotInExpr } from 'vs/platform/contextkey/common/contextkey';
...
import { toExtensionDescription } from 'vs/platform/extensionManagement/common/extensionsScannerService';
...
export class RemoteAgentEnvironmentChannel {
    ...
    static _namePool = 1;
    whenExtensionsReady;
    constructor(_connectionToken, _environmentService, _userDataProfilesService, extensionManagementCLI, _logService, _extensionHostStatusService, _extensionsScannerService, _extensionManagementService) {
